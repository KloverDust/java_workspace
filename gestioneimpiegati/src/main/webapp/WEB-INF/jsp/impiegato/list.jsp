				                	...
				                	<c:forEach items="${impiegato_list_attribute }" var="impiegatoItem">
										<tr>
											...
											<td>
												...
												<a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="${pageContext.request.contextPath}/impiegato/edit/${impiegatoItem.id }">Edit</a>
												<a class="btn btn-outline-danger btn-sm" href="${pageContext.request.contextPath}/impiegato/delete/${impiegatoItem.id }">Delete</a>
											</td>
										</tr>
									</c:forEach>
				                </tbody>
