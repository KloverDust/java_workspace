				                ...
				                <tbody>
				                	<c:forEach items="${satellite_list_attribute }" var="satelliteItem">
										<tr>
											...
											<td>
												<fmt:parseDate value="${satelliteItem.dataLancio}" pattern="yyyy-MM-dd" var="localDateToBeParsed1" type="date"/>
												<fmt:formatDate pattern="dd/MM/yyyy" value="${localDateToBeParsed1}" />
											</td>

											<td>
												<fmt:parseDate value="${satelliteItem.dataRientro}" pattern="yyyy-MM-dd" var="localDateToBeParsed2" type="date"/>
