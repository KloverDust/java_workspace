package it.prova.motociclettajdbs.connection;
...
public class MyConnection {
    ...
    private static final String CONNECT_STR = "jdbc:mysql://localhost:3306/settimana2giorno2?user=root&password=root&allowPublicKeyRetrieval=true&useSSL=FALSE&serverTimezone=UTC";
